...
class CnpjCei(ModelBase):
    ...
    identif_m_f = models.IntegerField(
        "Identificacao M/F", choices=IDENTIFICACAO, null=True, blank=True
    )
    name = models.CharField("Nome", max_length=250)
    fantasy_name = models.CharField(
        "Nome Fantasia", max_length=250, null=True, blank=True
    )
    legal_nature = models.IntegerField(
        "Natureza Juridica", choices=NATUREZA_JURIDICA, null=True, blank=True
    )
    ...
    registration_status = models.IntegerField(
        "Situação Cadastral", choices=SITUACAO_CADASTRAL, null=True, blank=True
    )
    date_registration_status = models.DateField(
        "Data do Status do Registro", null=True, blank=True
    )
    reason_situation = models.IntegerField(
        "Motivo Situação Cadastral", choices=MOTIVO_SITUACAO, null=True, blank=True
    )
    ...
    type_street = models.IntegerField(
        "Tipo de Logradouro", choices=TYPES_STREET, null=True, blank=True
    )
    ...
    complement_address = models.CharField(
        "Complemento", max_length=250, null=True, blank=True
    )
    ...
    type_identification = models.IntegerField(
        "Tipo", choices=TIPOS, null=True, blank=True
    )
